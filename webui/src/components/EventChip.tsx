...
export function EventChip({
  ...
  return <div className="flex justify-center">{onClick ? <button type="button" onClick={onClick} className={chipClassName} title={title}>{content}</button> : <div className={chipClassName}>{content}</div>}</div>;
}
