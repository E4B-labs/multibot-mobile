...
export function approvalRule(provider, tool, input, native) {
    if (native != null)
        return { provider, key: `native:${stable(native)}`, label: `${tool}: similar actions` };
    if (typeof input.command === "string")
        return { provider, ...commandRule(input.command) };
