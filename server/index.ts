...
import type { ApprovalRuleCandidate, RuntimeEvent } from "./contracts.ts";
...
async function startTurn(
  botId: string,
  text: string,
  opts?: { commsDepth?: number; reasoning?: ReasoningLevel; attachments?: ReturnType<AttachmentStore["resolveMany"]> },
) {
